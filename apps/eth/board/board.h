 ...
 * Board identifier.
 */
#define BOARD_STM32F107_DK_B
#define BOARD_NAME              "STM32F107 DK board"
...
#define BOARD_PHY_ID            0x20005C90

/*
 * IO pins assignments.
 */
#define GPIOA_SWITCH_WKUP       0
#define GPIOB_SWITCH_USER       7
#define GPIOC_SWITCH_TAMPER     13

#define GPIOE_LED1              8
#define GPIOE_LED2              9
#define GPIOE_LED3              10
#define GPIOE_LED4              11
#define GPIOE_LED5              12
#define GPIOE_LED6              13
#define GPIOE_LED7              14
#define GPIOE_LED8              15
 ...
 * Port E setup.
 * Everything input with pull-up except:
 * x PE14 - Normal input      (ETH_RMII_MDINT).
 * x PE15 - Normal input      (USB_FAULT).
 * PE8-PE15 - Open drain output (LED1-LED8)
 */
